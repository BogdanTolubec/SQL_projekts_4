...
--
-- Хост: 127.0.0.1
-- Час створення: Бер 10 2021 р., 12:57
...
--
-- Структура таблиці `coputer1`
--

CREATE TABLE `coputer1` (
  `id` int(4) NOT NULL,
...
--
-- Дамп даних таблиці `coputer1`
--

INSERT INTO `coputer1` (`id`, `codes`, `new`, `title`, `price`, `production`, `pages`, `format`, `dates`, `counts`, `topic`, `category`) VALUES
(2, 5110, 'Yes', 'Аппаратные средства мультимедия. Видеосистема РС', 15.51, 'BHV С.-Петербург', 400, '70х100/16', '2021-01-01', 5000, 'Використання ПК в цілому', 'Підручники'),
...
(9, 5141, 'No', 'Структуры данных и алгоритмы.', 40, 'Вильямс', 384, '70х100/16', '2000-09-29', 5000, 'Використання ПК в цілому', 'Підручники'),
...
(50, 3851, 'Yes', 'Защита информации и безопасность компьютерных систем', 0, 'DiaSoft', 480, '84х108/16', '1999-02-04', 5000, 'Використання ПК в цілому', 'Захист і безпека ПК'),
...
(7890, 10050, 'Yes', 'Програмування на PHP для початківців', 13, 'PHP production', 245, '70x100/16', '2020-02-03', 5000, 'Програмування', 'Навчальний посібник');
...
--
-- Індекси таблиці `coputer1`
--
ALTER TABLE `coputer1`
  ADD PRIMARY KEY (`id`);
COMMIT;
